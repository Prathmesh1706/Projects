...
def getWeather():
    ...
    photo1 = ImageTk.PhotoImage(file=f"D:/Weather forcast/icon/{firstdayimage}@2x.png")
    ...
    img=(Image.open(f"D:/Weather forcast/icon/{seconddayimage}@2x.png"))
    ...
    img=(Image.open(f"D:/Weather forcast/icon/{thirddayimage}@2x.png"))
    resized_image= img.resize((50,50))
    ...
    img=(Image.open(f"D:/Weather forcast/icon/{fourthdayimage}@2x.png"))
    resized_image= img.resize((50,50))
    ...
    img=(Image.open(f"D:/Weather forcast/icon/{fifthdayimage}@2x.png"))
    resized_image= img.resize((50,50))
    ...
    img=(Image.open(f"D:/Weather forcast/icon/{sixthdayimage}@2x.png"))
    resized_image= img.resize((50,50))
    ...
    img=(Image.open(f"D:/Weather forcast/icon/{seventhdayimage}@2x.png"))
    resized_image= img.resize((50,50))
...
##icon
image_icon=PhotoImage(file="D:/Weather forcast/Images/logo.png")
root.iconphoto(False,image_icon)

Round_box=PhotoImage(file="D:/Weather forcast/Images/Rounded Rectangle 1.png")
Label(root,image=Round_box,bg="#57adff").place(x=30,y=110)

#label
lable1=Label(root,text="Temperature",font=('Helvetica',11),fg="white",bg="#203243")
lable1.place(x=50,y=120)

lable2=Label(root,text="Humidity",font=('Helvetica',11),fg="white",bg="#203243")
lable2.place(x=50,y=140)

lable3=Label(root,text="Pressure",font=('Helvetica',11),fg="white",bg="#203243")
lable3.place(x=50,y=160)

lable4=Label(root,text="Wind Speed",font=('Helvetica',11),fg="white",bg="#203243")
lable4.place(x=50,y=180)

lable5=Label(root,text="Description",font=('Helvetica',11),fg="white",bg="#203243")
lable5.place(x=50,y=200)

##search box
Search_image=PhotoImage(file="D:/Weather forcast/Images/Rounded Rectangle 3.png")
myimage=Label(image=Search_image,bg="#57adff")
myimage.place(x=270,y=120)

weat_image=PhotoImage(file="D:/Weather forcast/Images/Layer 7.png")
...
Search_icon=PhotoImage(file="D:/Weather forcast/Images/Search.png")
...
##bottom boxes
firstbox=PhotoImage(file="D:/Weather forcast/Images/Rounded Rectangle 2.png")
secondbox=PhotoImage(file="D:/Weather forcast/Images/Rounded Rectangle 2 copy.png")
